const Icon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" height={44} viewBox="0 0 24 24">
      <g fill="#4CC9B3" className="hover:fill-white cursor-pointer">
        ...
        <path
          fillRule="evenodd"
          d="M8.641 12.641A4.75 4.75 0 0 1 16.75 16v.75h-9.5V16c0-1.26.5-2.468 1.391-3.359M12 12.75a3.25 3.25 0 0 0-3.162 2.5h6.324A3.25 3.25 0 0 0 12 12.75"
          clipRule="evenodd"
        ></path>
        <path
          fillRule="evenodd"
