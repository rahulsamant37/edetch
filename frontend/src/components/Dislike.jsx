...
const Dislike = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={44} viewBox="0 0 24 24" className="hover:fill-white cursor-pointer">
      <g fill="#4CC9B3" className="hover:fill-white cursor-pointer">
        ...
        <path
          fill="#4CC9B3" className="hover:fill-white cursor-pointer"
